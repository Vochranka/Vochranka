...
const iconData: LucideIconData = {"name":"arrow-left-to-line","size":24,"node":[["path",{"d":"M3 19V5"}],["path",{"d":"m13 6-6 6 6 6"}],["path",{"d":"M7 12h14"}]]};
 ...
 * 
 */
const ArrowLeftToLine = createLucideIcon(iconData) as AstroComponent;
