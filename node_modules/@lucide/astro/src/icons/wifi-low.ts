...
const iconData: LucideIconData = {"name":"wifi-low","size":24,"node":[["path",{"d":"M12 20h.01"}],["path",{"d":"M8.5 16.429a5 5 0 0 1 7 0"}]]};
 ...
 * 
 */
const WifiLow = createLucideIcon(iconData) as AstroComponent;
