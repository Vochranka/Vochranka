...
const iconData: LucideIconData = {"name":"navigation","size":24,"node":[["polygon",{"points":"3 11 22 2 13 21 11 13 3 11"}]]};
 ...
 * 
 */
const Navigation = createLucideIcon(iconData) as AstroComponent;
