...
const iconData: LucideIconData = {"name":"signal-medium","size":24,"node":[["path",{"d":"M2 20h.01"}],["path",{"d":"M7 20v-4"}],["path",{"d":"M12 20v-8"}]]};
 ...
 * 
 */
const SignalMedium = createLucideIcon(iconData) as AstroComponent;
