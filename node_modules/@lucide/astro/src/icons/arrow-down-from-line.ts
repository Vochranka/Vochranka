...
const iconData: LucideIconData = {"name":"arrow-down-from-line","size":24,"node":[["path",{"d":"M19 3H5"}],["path",{"d":"M12 21V7"}],["path",{"d":"m6 15 6 6 6-6"}]]};
 ...
 * 
 */
const ArrowDownFromLine = createLucideIcon(iconData) as AstroComponent;
