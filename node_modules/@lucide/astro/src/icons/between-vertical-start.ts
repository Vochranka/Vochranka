...
const iconData: LucideIconData = {"name":"between-vertical-start","size":24,"node":[["rect",{"width":"7","height":"13","x":"3","y":"8","rx":"1"}],["path",{"d":"m15 2-3 3-3-3"}],["rect",{"width":"7","height":"13","x":"14","y":"8","rx":"1"}]]};
 ...
 * 
 */
const BetweenVerticalStart = createLucideIcon(iconData) as AstroComponent;
