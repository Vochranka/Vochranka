...
const iconData: LucideIconData = {"name":"grid-3x3","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["path",{"d":"M3 9h18"}],["path",{"d":"M3 15h18"}],["path",{"d":"M9 3v18"}],["path",{"d":"M15 3v18"}]],"aliases":["grid","grid-3-x-3"]};
 ...
 * 
 */
const Grid3x3 = createLucideIcon(iconData) as AstroComponent;
