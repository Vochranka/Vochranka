...
const iconData: LucideIconData = {"name":"chevrons-right","size":24,"node":[["path",{"d":"m6 17 5-5-5-5"}],["path",{"d":"m13 17 5-5-5-5"}]]};
 ...
 * 
 */
const ChevronsRight = createLucideIcon(iconData) as AstroComponent;
