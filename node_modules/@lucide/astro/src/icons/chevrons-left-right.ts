...
const iconData: LucideIconData = {"name":"chevrons-left-right","size":24,"node":[["path",{"d":"m9 7-5 5 5 5"}],["path",{"d":"m15 7 5 5-5 5"}]]};
 ...
 * 
 */
const ChevronsLeftRight = createLucideIcon(iconData) as AstroComponent;
