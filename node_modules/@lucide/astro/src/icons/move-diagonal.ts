...
const iconData: LucideIconData = {"name":"move-diagonal","size":24,"node":[["path",{"d":"M11 19H5v-6"}],["path",{"d":"M13 5h6v6"}],["path",{"d":"M19 5 5 19"}]]};
 ...
 * 
 */
const MoveDiagonal = createLucideIcon(iconData) as AstroComponent;
