...
const iconData: LucideIconData = {"name":"music-2","size":24,"node":[["circle",{"cx":"8","cy":"18","r":"4"}],["path",{"d":"M12 18V2l7 4"}]]};
 ...
 * 
 */
const Music2 = createLucideIcon(iconData) as AstroComponent;
