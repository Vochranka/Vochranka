...
const iconData: LucideIconData = {"name":"arrow-down-1-0","size":24,"node":[["path",{"d":"m3 16 4 4 4-4"}],["path",{"d":"M7 20V4"}],["path",{"d":"M17 10V4h-2"}],["path",{"d":"M15 10h4"}],["rect",{"x":"15","y":"14","width":"4","height":"6","ry":"2"}]],"aliases":["arrow-down-10"]};
 ...
 * 
 */
const ArrowDown10 = createLucideIcon(iconData) as AstroComponent;
