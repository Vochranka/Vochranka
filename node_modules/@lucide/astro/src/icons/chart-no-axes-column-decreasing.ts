...
const iconData: LucideIconData = {"name":"chart-no-axes-column-decreasing","size":24,"node":[["path",{"d":"M5 21V3"}],["path",{"d":"M12 21V9"}],["path",{"d":"M19 21v-6"}]]};
 ...
 * 
 */
const ChartNoAxesColumnDecreasing = createLucideIcon(iconData) as AstroComponent;
