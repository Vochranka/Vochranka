...
const iconData: LucideIconData = {"name":"clock-arrow-right","size":24,"node":[["path",{"d":"M12 6v6l2 1"}],["path",{"d":"M13.5 21.885A10 10 0 1 1 22 12"}],["path",{"d":"M14 18h8"}],["path",{"d":"m18 22 4-4-4-4"}]]};
 ...
 * 
 */
const ClockArrowRight = createLucideIcon(iconData) as AstroComponent;
