...
const iconData: LucideIconData = {"name":"circle-equal","size":24,"node":[["circle",{"cx":"12","cy":"12","r":"10"}],["path",{"d":"M7 10h10"}],["path",{"d":"M7 14h10"}]]};
 ...
 * 
 */
const CircleEqual = createLucideIcon(iconData) as AstroComponent;
