...
const iconData: LucideIconData = {"name":"move-left","size":24,"node":[["path",{"d":"M6 8L2 12L6 16"}],["path",{"d":"M2 12H22"}]]};
 ...
 * 
 */
const MoveLeft = createLucideIcon(iconData) as AstroComponent;
