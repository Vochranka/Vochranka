...
const iconData: LucideIconData = {"name":"search-slash","size":24,"node":[["path",{"d":"m13.5 8.5-5 5"}],["circle",{"cx":"11","cy":"11","r":"8"}],["path",{"d":"m21 21-4.3-4.3"}]]};
 ...
 * 
 */
const SearchSlash = createLucideIcon(iconData) as AstroComponent;
