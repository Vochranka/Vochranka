...
const iconData: LucideIconData = {"name":"folder-x","size":24,"node":[["path",{"d":"M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z"}],["path",{"d":"m9.5 10.5 5 5"}],["path",{"d":"m14.5 10.5-5 5"}]]};
 ...
 * 
 */
const FolderX = createLucideIcon(iconData) as AstroComponent;
