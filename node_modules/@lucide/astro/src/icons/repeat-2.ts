...
const iconData: LucideIconData = {"name":"repeat-2","size":24,"node":[["path",{"d":"m2 9 3-3 3 3"}],["path",{"d":"M13 18H7a2 2 0 0 1-2-2V6"}],["path",{"d":"m22 15-3 3-3-3"}],["path",{"d":"M11 6h6a2 2 0 0 1 2 2v10"}]]};
 ...
 * 
 */
const Repeat2 = createLucideIcon(iconData) as AstroComponent;
