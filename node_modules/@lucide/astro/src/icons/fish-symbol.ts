...
const iconData: LucideIconData = {"name":"fish-symbol","size":24,"node":[["path",{"d":"M2 16s9-15 20-4C11 23 2 8 2 8"}]]};
 ...
 * 
 */
const FishSymbol = createLucideIcon(iconData) as AstroComponent;
