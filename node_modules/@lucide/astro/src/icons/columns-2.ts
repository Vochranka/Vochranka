...
const iconData: LucideIconData = {"name":"columns-2","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["path",{"d":"M12 3v18"}]],"aliases":["columns"]};
 ...
 * 
 */
const Columns2 = createLucideIcon(iconData) as AstroComponent;
