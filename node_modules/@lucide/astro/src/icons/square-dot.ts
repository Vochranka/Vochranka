...
const iconData: LucideIconData = {"name":"square-dot","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["circle",{"cx":"12","cy":"12","r":"1"}]],"aliases":["dot-square"]};
 ...
 * 
 */
const SquareDot = createLucideIcon(iconData) as AstroComponent;
