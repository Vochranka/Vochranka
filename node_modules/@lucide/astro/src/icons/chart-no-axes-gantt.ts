...
const iconData: LucideIconData = {"name":"chart-no-axes-gantt","size":24,"node":[["path",{"d":"M6 5h12"}],["path",{"d":"M4 12h10"}],["path",{"d":"M12 19h8"}]],"aliases":["gantt-chart"]};
 ...
 * 
 */
const ChartNoAxesGantt = createLucideIcon(iconData) as AstroComponent;
