...
const iconData: LucideIconData = {"name":"disc","size":24,"node":[["circle",{"cx":"12","cy":"12","r":"10"}],["circle",{"cx":"12","cy":"12","r":"2"}]]};
 ...
 * 
 */
const Disc = createLucideIcon(iconData) as AstroComponent;
