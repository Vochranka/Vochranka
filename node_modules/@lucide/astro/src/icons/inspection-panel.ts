...
const iconData: LucideIconData = {"name":"inspection-panel","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["path",{"d":"M7 7h.01"}],["path",{"d":"M17 7h.01"}],["path",{"d":"M7 17h.01"}],["path",{"d":"M17 17h.01"}]]};
 ...
 * 
 */
const InspectionPanel = createLucideIcon(iconData) as AstroComponent;
