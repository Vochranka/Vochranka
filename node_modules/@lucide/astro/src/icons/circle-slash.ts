...
const iconData: LucideIconData = {"name":"circle-slash","size":24,"node":[["circle",{"cx":"12","cy":"12","r":"10"}],["line",{"x1":"9","x2":"15","y1":"15","y2":"9"}]]};
 ...
 * 
 */
const CircleSlash = createLucideIcon(iconData) as AstroComponent;
