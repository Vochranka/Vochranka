...
const iconData: LucideIconData = {"name":"arrow-down-up","size":24,"node":[["path",{"d":"m3 16 4 4 4-4"}],["path",{"d":"M7 20V4"}],["path",{"d":"m21 8-4-4-4 4"}],["path",{"d":"M17 4v16"}]]};
 ...
 * 
 */
const ArrowDownUp = createLucideIcon(iconData) as AstroComponent;
