...
const iconData: LucideIconData = {"name":"redo-2","size":24,"node":[["path",{"d":"m15 14 5-5-5-5"}],["path",{"d":"M20 9H9.5A5.5 5.5 0 0 0 4 14.5A5.5 5.5 0 0 0 9.5 20H13"}]]};
 ...
 * 
 */
const Redo2 = createLucideIcon(iconData) as AstroComponent;
