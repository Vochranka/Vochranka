...
const iconData: LucideIconData = {"name":"align-vertical-space-around","size":24,"node":[["rect",{"width":"10","height":"6","x":"7","y":"9","rx":"2"}],["path",{"d":"M22 20H2"}],["path",{"d":"M22 4H2"}]]};
 ...
 * 
 */
const AlignVerticalSpaceAround = createLucideIcon(iconData) as AstroComponent;
