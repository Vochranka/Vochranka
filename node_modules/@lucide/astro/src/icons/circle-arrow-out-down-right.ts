...
const iconData: LucideIconData = {"name":"circle-arrow-out-down-right","size":24,"node":[["path",{"d":"M12 22a10 10 0 1 1 10-10"}],["path",{"d":"M22 22 12 12"}],["path",{"d":"M22 16v6h-6"}]],"aliases":["arrow-down-right-from-circle"]};
 ...
 * 
 */
const CircleArrowOutDownRight = createLucideIcon(iconData) as AstroComponent;
