...
const iconData: LucideIconData = {"name":"circle-arrow-left","size":24,"node":[["circle",{"cx":"12","cy":"12","r":"10"}],["path",{"d":"m12 8-4 4 4 4"}],["path",{"d":"M16 12H8"}]],"aliases":["arrow-left-circle"]};
 ...
 * 
 */
const CircleArrowLeft = createLucideIcon(iconData) as AstroComponent;
