...
const iconData: LucideIconData = {"name":"arrow-up-from-line","size":24,"node":[["path",{"d":"m18 9-6-6-6 6"}],["path",{"d":"M12 3v14"}],["path",{"d":"M5 21h14"}]]};
 ...
 * 
 */
const ArrowUpFromLine = createLucideIcon(iconData) as AstroComponent;
