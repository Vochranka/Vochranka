...
const iconData: LucideIconData = {"name":"list-chevrons-down-up","size":24,"node":[["path",{"d":"M3 5h8"}],["path",{"d":"M3 12h8"}],["path",{"d":"M3 19h8"}],["path",{"d":"m15 5 3 3 3-3"}],["path",{"d":"m15 19 3-3 3 3"}]]};
 ...
 * 
 */
const ListChevronsDownUp = createLucideIcon(iconData) as AstroComponent;
