...
const iconData: LucideIconData = {"name":"arrow-up-wide-narrow","size":24,"node":[["path",{"d":"m3 8 4-4 4 4"}],["path",{"d":"M7 4v16"}],["path",{"d":"M11 12h10"}],["path",{"d":"M11 16h7"}],["path",{"d":"M11 20h4"}]]};
 ...
 * 
 */
const ArrowUpWideNarrow = createLucideIcon(iconData) as AstroComponent;
