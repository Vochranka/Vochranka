...
const iconData: LucideIconData = {"name":"move-vertical","size":24,"node":[["path",{"d":"M12 2v20"}],["path",{"d":"m8 18 4 4 4-4"}],["path",{"d":"m8 6 4-4 4 4"}]]};
 ...
 * 
 */
const MoveVertical = createLucideIcon(iconData) as AstroComponent;
