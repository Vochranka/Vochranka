...
const iconData: LucideIconData = {"name":"arrow-right-to-line","size":24,"node":[["path",{"d":"M17 12H3"}],["path",{"d":"m11 18 6-6-6-6"}],["path",{"d":"M21 5v14"}]]};
 ...
 * 
 */
const ArrowRightToLine = createLucideIcon(iconData) as AstroComponent;
