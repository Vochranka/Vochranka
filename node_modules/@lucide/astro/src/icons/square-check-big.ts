...
const iconData: LucideIconData = {"name":"square-check-big","size":24,"node":[["path",{"d":"M21 10.656V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h12.344"}],["path",{"d":"m9 11 3 3L22 4"}]],"aliases":["check-square"]};
 ...
 * 
 */
const SquareCheckBig = createLucideIcon(iconData) as AstroComponent;
