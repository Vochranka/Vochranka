...
const iconData: LucideIconData = {"name":"check-check","size":24,"node":[["path",{"d":"M18 6 7 17l-5-5"}],["path",{"d":"m22 10-7.5 7.5L13 16"}]]};
 ...
 * 
 */
const CheckCheck = createLucideIcon(iconData) as AstroComponent;
