...
const iconData: LucideIconData = {"name":"square-equal","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["path",{"d":"M7 10h10"}],["path",{"d":"M7 14h10"}]],"aliases":["equal-square"]};
 ...
 * 
 */
const SquareEqual = createLucideIcon(iconData) as AstroComponent;
