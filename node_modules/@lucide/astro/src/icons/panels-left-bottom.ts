...
const iconData: LucideIconData = {"name":"panels-left-bottom","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["path",{"d":"M9 3v18"}],["path",{"d":"M9 15h12"}]]};
 ...
 * 
 */
const PanelsLeftBottom = createLucideIcon(iconData) as AstroComponent;
