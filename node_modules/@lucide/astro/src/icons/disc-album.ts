...
const iconData: LucideIconData = {"name":"disc-album","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["circle",{"cx":"12","cy":"12","r":"5"}],["path",{"d":"M12 12h.01"}]]};
 ...
 * 
 */
const DiscAlbum = createLucideIcon(iconData) as AstroComponent;
