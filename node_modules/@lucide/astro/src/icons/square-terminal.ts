...
const iconData: LucideIconData = {"name":"square-terminal","size":24,"node":[["path",{"d":"m7 11 2-2-2-2"}],["path",{"d":"M11 13h4"}],["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2","ry":"2"}]],"aliases":["terminal-square"]};
 ...
 * 
 */
const SquareTerminal = createLucideIcon(iconData) as AstroComponent;
