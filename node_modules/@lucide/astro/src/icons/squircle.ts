...
const iconData: LucideIconData = {"name":"squircle","size":24,"node":[["path",{"d":"M12 3c7.2 0 9 1.8 9 9s-1.8 9-9 9-9-1.8-9-9 1.8-9 9-9"}]]};
 ...
 * 
 */
const Squircle = createLucideIcon(iconData) as AstroComponent;
