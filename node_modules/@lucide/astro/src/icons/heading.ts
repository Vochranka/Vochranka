...
const iconData: LucideIconData = {"name":"heading","size":24,"node":[["path",{"d":"M6 12h12"}],["path",{"d":"M6 20V4"}],["path",{"d":"M18 20V4"}]]};
 ...
 * 
 */
const Heading = createLucideIcon(iconData) as AstroComponent;
