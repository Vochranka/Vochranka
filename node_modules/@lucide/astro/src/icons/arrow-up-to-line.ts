...
const iconData: LucideIconData = {"name":"arrow-up-to-line","size":24,"node":[["path",{"d":"M5 3h14"}],["path",{"d":"m18 13-6-6-6 6"}],["path",{"d":"M12 7v14"}]]};
 ...
 * 
 */
const ArrowUpToLine = createLucideIcon(iconData) as AstroComponent;
