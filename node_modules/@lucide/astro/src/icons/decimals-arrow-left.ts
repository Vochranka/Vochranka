...
const iconData: LucideIconData = {"name":"decimals-arrow-left","size":24,"node":[["path",{"d":"m13 21-3-3 3-3"}],["path",{"d":"M20 18H10"}],["path",{"d":"M3 11h.01"}],["rect",{"x":"6","y":"3","width":"5","height":"8","rx":"2.5"}]]};
 ...
 * 
 */
const DecimalsArrowLeft = createLucideIcon(iconData) as AstroComponent;
