...
const iconData: LucideIconData = {"name":"parentheses","size":24,"node":[["path",{"d":"M8 21s-4-3-4-9 4-9 4-9"}],["path",{"d":"M16 3s4 3 4 9-4 9-4 9"}]]};
 ...
 * 
 */
const Parentheses = createLucideIcon(iconData) as AstroComponent;
