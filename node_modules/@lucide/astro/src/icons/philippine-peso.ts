...
const iconData: LucideIconData = {"name":"philippine-peso","size":24,"node":[["path",{"d":"M20 11H4"}],["path",{"d":"M20 7H4"}],["path",{"d":"M7 21V4a1 1 0 0 1 1-1h4a1 1 0 0 1 0 12H7"}]]};
 ...
 * 
 */
const PhilippinePeso = createLucideIcon(iconData) as AstroComponent;
