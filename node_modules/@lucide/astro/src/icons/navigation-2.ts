...
const iconData: LucideIconData = {"name":"navigation-2","size":24,"node":[["polygon",{"points":"12 2 19 21 12 17 5 21 12 2"}]]};
 ...
 * 
 */
const Navigation2 = createLucideIcon(iconData) as AstroComponent;
