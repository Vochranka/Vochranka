...
const iconData: LucideIconData = {"name":"corner-right-up","size":24,"node":[["path",{"d":"m10 9 5-5 5 5"}],["path",{"d":"M4 20h7a4 4 0 0 0 4-4V4"}]]};
 ...
 * 
 */
const CornerRightUp = createLucideIcon(iconData) as AstroComponent;
