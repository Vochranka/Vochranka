...
const iconData: LucideIconData = {"name":"square-arrow-out-down-right","size":24,"node":[["path",{"d":"M21 11V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h6"}],["path",{"d":"m21 21-9-9"}],["path",{"d":"M21 15v6h-6"}]],"aliases":["arrow-down-right-from-square"]};
 ...
 * 
 */
const SquareArrowOutDownRight = createLucideIcon(iconData) as AstroComponent;
