...
const iconData: LucideIconData = {"name":"arrow-down-to-line","size":24,"node":[["path",{"d":"M12 17V3"}],["path",{"d":"m6 11 6 6 6-6"}],["path",{"d":"M19 21H5"}]]};
 ...
 * 
 */
const ArrowDownToLine = createLucideIcon(iconData) as AstroComponent;
