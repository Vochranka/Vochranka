...
const iconData: LucideIconData = {"name":"align-horizontal-justify-center","size":24,"node":[["rect",{"width":"6","height":"14","x":"2","y":"5","rx":"2"}],["rect",{"width":"6","height":"10","x":"16","y":"7","rx":"2"}],["path",{"d":"M12 2v20"}]]};
 ...
 * 
 */
const AlignHorizontalJustifyCenter = createLucideIcon(iconData) as AstroComponent;
