...
const iconData: LucideIconData = {"name":"trending-down","size":24,"node":[["path",{"d":"M16 17h6v-6"}],["path",{"d":"m22 17-8.5-8.5-5 5L2 7"}]]};
 ...
 * 
 */
const TrendingDown = createLucideIcon(iconData) as AstroComponent;
