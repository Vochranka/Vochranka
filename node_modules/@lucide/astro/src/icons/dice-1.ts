...
const iconData: LucideIconData = {"name":"dice-1","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2","ry":"2"}],["path",{"d":"M12 12h.01"}]]};
 ...
 * 
 */
const Dice1 = createLucideIcon(iconData) as AstroComponent;
