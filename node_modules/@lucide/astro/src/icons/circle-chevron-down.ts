...
const iconData: LucideIconData = {"name":"circle-chevron-down","size":24,"node":[["circle",{"cx":"12","cy":"12","r":"10"}],["path",{"d":"m16 10-4 4-4-4"}]],"aliases":["chevron-down-circle"]};
 ...
 * 
 */
const CircleChevronDown = createLucideIcon(iconData) as AstroComponent;
