...
const iconData: LucideIconData = {"name":"line-dot-right-horizontal","size":24,"node":[["path",{"d":"M 3 12 L 15 12"}],["circle",{"cx":"18","cy":"12","r":"3"}]]};
 ...
 * 
 */
const LineDotRightHorizontal = createLucideIcon(iconData) as AstroComponent;
