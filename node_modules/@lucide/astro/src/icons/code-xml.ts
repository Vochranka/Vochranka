...
const iconData: LucideIconData = {"name":"code-xml","size":24,"node":[["path",{"d":"m18 16 4-4-4-4"}],["path",{"d":"m6 8-4 4 4 4"}],["path",{"d":"m14.5 4-5 16"}]],"aliases":["code-2"]};
 ...
 * 
 */
const CodeXml = createLucideIcon(iconData) as AstroComponent;
