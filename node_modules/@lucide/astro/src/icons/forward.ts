...
const iconData: LucideIconData = {"name":"forward","size":24,"node":[["path",{"d":"m15 17 5-5-5-5"}],["path",{"d":"M4 18v-2a4 4 0 0 1 4-4h12"}]]};
 ...
 * 
 */
const Forward = createLucideIcon(iconData) as AstroComponent;
