...
const iconData: LucideIconData = {"name":"arrow-right-from-line","size":24,"node":[["path",{"d":"M3 5v14"}],["path",{"d":"M21 12H7"}],["path",{"d":"m15 18 6-6-6-6"}]]};
 ...
 * 
 */
const ArrowRightFromLine = createLucideIcon(iconData) as AstroComponent;
