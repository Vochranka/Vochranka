...
const iconData: LucideIconData = {"name":"x-line-top","size":24,"node":[["path",{"d":"M18 4H6"}],["path",{"d":"M18 8 6 20"}],["path",{"d":"m6 8 12 12"}]]};
 ...
 * 
 */
const XLineTop = createLucideIcon(iconData) as AstroComponent;
