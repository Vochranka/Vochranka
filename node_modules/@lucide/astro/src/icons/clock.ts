...
const iconData: LucideIconData = {"name":"clock","size":24,"node":[["circle",{"cx":"12","cy":"12","r":"10"}],["path",{"d":"M12 6v6l4 2"}]]};
 ...
 * 
 */
const Clock = createLucideIcon(iconData) as AstroComponent;
