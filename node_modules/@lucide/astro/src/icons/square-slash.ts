...
const iconData: LucideIconData = {"name":"square-slash","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["line",{"x1":"9","x2":"15","y1":"15","y2":"9"}]],"aliases":["slash-square"]};
 ...
 * 
 */
const SquareSlash = createLucideIcon(iconData) as AstroComponent;
