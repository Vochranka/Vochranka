...
const iconData: LucideIconData = {"name":"shelving-unit","size":24,"node":[["path",{"d":"M12 12V9a1 1 0 0 0-1-1H9a1 1 0 0 0-1 1v3"}],["path",{"d":"M16 20v-3a1 1 0 0 0-1-1h-2a1 1 0 0 0-1 1v3"}],["path",{"d":"M20 22V2"}],["path",{"d":"M4 12h16"}],["path",{"d":"M4 20h16"}],["path",{"d":"M4 2v20"}],["path",{"d":"M4 4h16"}]]};
 ...
 * 
 */
const ShelvingUnit = createLucideIcon(iconData) as AstroComponent;
