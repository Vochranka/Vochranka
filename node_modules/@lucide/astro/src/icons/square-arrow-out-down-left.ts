...
const iconData: LucideIconData = {"name":"square-arrow-out-down-left","size":24,"node":[["path",{"d":"M13 21h6a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v6"}],["path",{"d":"m3 21 9-9"}],["path",{"d":"M9 21H3v-6"}]],"aliases":["arrow-down-left-from-square"]};
 ...
 * 
 */
const SquareArrowOutDownLeft = createLucideIcon(iconData) as AstroComponent;
