...
const iconData: LucideIconData = {"name":"chevrons-down","size":24,"node":[["path",{"d":"m7 6 5 5 5-5"}],["path",{"d":"m7 13 5 5 5-5"}]]};
 ...
 * 
 */
const ChevronsDown = createLucideIcon(iconData) as AstroComponent;
