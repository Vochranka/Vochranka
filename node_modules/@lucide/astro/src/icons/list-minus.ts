...
const iconData: LucideIconData = {"name":"list-minus","size":24,"node":[["path",{"d":"M16 5H3"}],["path",{"d":"M11 12H3"}],["path",{"d":"M16 19H3"}],["path",{"d":"M21 12h-6"}]]};
 ...
 * 
 */
const ListMinus = createLucideIcon(iconData) as AstroComponent;
