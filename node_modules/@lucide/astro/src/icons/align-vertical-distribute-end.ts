...
const iconData: LucideIconData = {"name":"align-vertical-distribute-end","size":24,"node":[["rect",{"width":"14","height":"6","x":"5","y":"14","rx":"2"}],["rect",{"width":"10","height":"6","x":"7","y":"4","rx":"2"}],["path",{"d":"M2 20h20"}],["path",{"d":"M2 10h20"}]]};
 ...
 * 
 */
const AlignVerticalDistributeEnd = createLucideIcon(iconData) as AstroComponent;
