...
const iconData: LucideIconData = {"name":"chevrons-up","size":24,"node":[["path",{"d":"m17 11-5-5-5 5"}],["path",{"d":"m17 18-5-5-5 5"}]]};
 ...
 * 
 */
const ChevronsUp = createLucideIcon(iconData) as AstroComponent;
