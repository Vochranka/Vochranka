...
const iconData: LucideIconData = {"name":"grid-3x2","size":24,"node":[["path",{"d":"M15 3v18"}],["path",{"d":"M3 12h18"}],["path",{"d":"M9 3v18"}],["rect",{"x":"3","y":"3","width":"18","height":"18","rx":"2"}]]};
 ...
 * 
 */
const Grid3x2 = createLucideIcon(iconData) as AstroComponent;
