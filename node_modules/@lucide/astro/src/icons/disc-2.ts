...
const iconData: LucideIconData = {"name":"disc-2","size":24,"node":[["circle",{"cx":"12","cy":"12","r":"10"}],["circle",{"cx":"12","cy":"12","r":"4"}],["path",{"d":"M12 12h.01"}]]};
 ...
 * 
 */
const Disc2 = createLucideIcon(iconData) as AstroComponent;
