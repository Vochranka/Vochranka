...
const iconData: LucideIconData = {"name":"gauge","size":24,"node":[["path",{"d":"m12 14 4-4"}],["path",{"d":"M3.34 19a10 10 0 1 1 17.32 0"}]]};
 ...
 * 
 */
const Gauge = createLucideIcon(iconData) as AstroComponent;
