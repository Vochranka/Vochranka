...
const iconData: LucideIconData = {"name":"move-up-left","size":24,"node":[["path",{"d":"M5 11V5H11"}],["path",{"d":"M5 5L19 19"}]]};
 ...
 * 
 */
const MoveUpLeft = createLucideIcon(iconData) as AstroComponent;
