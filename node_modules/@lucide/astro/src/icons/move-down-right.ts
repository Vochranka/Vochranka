...
const iconData: LucideIconData = {"name":"move-down-right","size":24,"node":[["path",{"d":"M19 13V19H13"}],["path",{"d":"M5 5L19 19"}]]};
 ...
 * 
 */
const MoveDownRight = createLucideIcon(iconData) as AstroComponent;
