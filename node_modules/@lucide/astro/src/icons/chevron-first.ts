...
const iconData: LucideIconData = {"name":"chevron-first","size":24,"node":[["path",{"d":"m17 18-6-6 6-6"}],["path",{"d":"M7 6v12"}]]};
 ...
 * 
 */
const ChevronFirst = createLucideIcon(iconData) as AstroComponent;
