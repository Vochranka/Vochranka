...
const iconData: LucideIconData = {"name":"square-user-round","size":24,"node":[["path",{"d":"M18 21a6 6 0 0 0-12 0"}],["circle",{"cx":"12","cy":"11","r":"4"}],["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}]],"aliases":["user-square-2"]};
 ...
 * 
 */
const SquareUserRound = createLucideIcon(iconData) as AstroComponent;
