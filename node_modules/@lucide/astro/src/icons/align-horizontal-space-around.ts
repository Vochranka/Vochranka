...
const iconData: LucideIconData = {"name":"align-horizontal-space-around","size":24,"node":[["rect",{"width":"6","height":"10","x":"9","y":"7","rx":"2"}],["path",{"d":"M4 22V2"}],["path",{"d":"M20 22V2"}]]};
 ...
 * 
 */
const AlignHorizontalSpaceAround = createLucideIcon(iconData) as AstroComponent;
