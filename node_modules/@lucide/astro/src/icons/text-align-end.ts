...
const iconData: LucideIconData = {"name":"text-align-end","size":24,"node":[["path",{"d":"M21 5H3"}],["path",{"d":"M21 12H9"}],["path",{"d":"M21 19H7"}]],"aliases":["align-right"]};
 ...
 * 
 */
const TextAlignEnd = createLucideIcon(iconData) as AstroComponent;
