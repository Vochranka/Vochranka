...
const iconData: LucideIconData = {"name":"square-arrow-up","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["path",{"d":"m16 12-4-4-4 4"}],["path",{"d":"M12 16V8"}]],"aliases":["arrow-up-square"]};
 ...
 * 
 */
const SquareArrowUp = createLucideIcon(iconData) as AstroComponent;
