...
const iconData: LucideIconData = {"name":"arrow-left-from-line","size":24,"node":[["path",{"d":"m9 6-6 6 6 6"}],["path",{"d":"M3 12h14"}],["path",{"d":"M21 19V5"}]]};
 ...
 * 
 */
const ArrowLeftFromLine = createLucideIcon(iconData) as AstroComponent;
