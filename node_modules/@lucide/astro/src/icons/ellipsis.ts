...
const iconData: LucideIconData = {"name":"ellipsis","size":24,"node":[["circle",{"cx":"12","cy":"12","r":"1"}],["circle",{"cx":"19","cy":"12","r":"1"}],["circle",{"cx":"5","cy":"12","r":"1"}]],"aliases":["more-horizontal"]};
 ...
 * 
 */
const Ellipsis = createLucideIcon(iconData) as AstroComponent;
