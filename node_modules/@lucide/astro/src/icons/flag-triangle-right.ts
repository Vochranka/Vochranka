...
const iconData: LucideIconData = {"name":"flag-triangle-right","size":24,"node":[["path",{"d":"M6 22V2.8a.8.8 0 0 1 1.17-.71l11.38 5.69a.8.8 0 0 1 0 1.44L6 15.5"}]]};
 ...
 * 
 */
const FlagTriangleRight = createLucideIcon(iconData) as AstroComponent;
