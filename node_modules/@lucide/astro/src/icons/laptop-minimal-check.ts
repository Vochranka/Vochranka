...
const iconData: LucideIconData = {"name":"laptop-minimal-check","size":24,"node":[["path",{"d":"M2 20h20"}],["path",{"d":"m9 10 2 2 4-4"}],["rect",{"x":"3","y":"4","width":"18","height":"12","rx":"2"}]]};
 ...
 * 
 */
const LaptopMinimalCheck = createLucideIcon(iconData) as AstroComponent;
