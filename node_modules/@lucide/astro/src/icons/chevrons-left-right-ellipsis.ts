...
const iconData: LucideIconData = {"name":"chevrons-left-right-ellipsis","size":24,"node":[["path",{"d":"M12 12h.01"}],["path",{"d":"M16 12h.01"}],["path",{"d":"m17 7 5 5-5 5"}],["path",{"d":"m7 7-5 5 5 5"}],["path",{"d":"M8 12h.01"}]]};
 ...
 * 
 */
const ChevronsLeftRightEllipsis = createLucideIcon(iconData) as AstroComponent;
