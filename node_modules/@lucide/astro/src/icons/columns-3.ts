...
const iconData: LucideIconData = {"name":"columns-3","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["path",{"d":"M9 3v18"}],["path",{"d":"M15 3v18"}]],"aliases":["panels-left-right"]};
 ...
 * 
 */
const Columns3 = createLucideIcon(iconData) as AstroComponent;
