...
const iconData: LucideIconData = {"name":"map-pin-x","size":24,"node":[["path",{"d":"M19.752 11.901A7.78 7.78 0 0 0 20 10a8 8 0 0 0-16 0c0 4.993 5.539 10.193 7.399 11.799a1 1 0 0 0 1.202 0 19 19 0 0 0 .09-.077"}],["circle",{"cx":"12","cy":"10","r":"3"}],["path",{"d":"m21.5 15.5-5 5"}],["path",{"d":"m21.5 20.5-5-5"}]]};
 ...
 * 
 */
const MapPinX = createLucideIcon(iconData) as AstroComponent;
