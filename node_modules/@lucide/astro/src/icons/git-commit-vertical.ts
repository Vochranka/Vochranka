...
const iconData: LucideIconData = {"name":"git-commit-vertical","size":24,"node":[["path",{"d":"M12 3v6"}],["circle",{"cx":"12","cy":"12","r":"3"}],["path",{"d":"M12 15v6"}]]};
 ...
 * 
 */
const GitCommitVertical = createLucideIcon(iconData) as AstroComponent;
