...
const iconData: LucideIconData = {"name":"calendar-minus","size":24,"node":[["path",{"d":"M16 18h6"}],["path",{"d":"M16 2v3"}],["path",{"d":"M21 14V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2h8.3"}],["path",{"d":"M3 9h18"}],["path",{"d":"M8 2v3"}]]};
 ...
 * 
 */
const CalendarMinus = createLucideIcon(iconData) as AstroComponent;
