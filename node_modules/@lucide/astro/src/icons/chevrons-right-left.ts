...
const iconData: LucideIconData = {"name":"chevrons-right-left","size":24,"node":[["path",{"d":"m20 17-5-5 5-5"}],["path",{"d":"m4 17 5-5-5-5"}]]};
 ...
 * 
 */
const ChevronsRightLeft = createLucideIcon(iconData) as AstroComponent;
