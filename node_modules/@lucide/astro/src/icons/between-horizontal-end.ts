...
const iconData: LucideIconData = {"name":"between-horizontal-end","size":24,"node":[["rect",{"width":"13","height":"7","x":"3","y":"3","rx":"1"}],["path",{"d":"m22 15-3-3 3-3"}],["rect",{"width":"13","height":"7","x":"3","y":"14","rx":"1"}]],"aliases":["between-horizonal-end"]};
 ...
 * 
 */
const BetweenHorizontalEnd = createLucideIcon(iconData) as AstroComponent;
