...
const iconData: LucideIconData = {"name":"monitor-up","size":24,"node":[["path",{"d":"m9 10 3-3 3 3"}],["path",{"d":"M12 13V7"}],["rect",{"width":"20","height":"14","x":"2","y":"3","rx":"2"}],["path",{"d":"M12 17v4"}],["path",{"d":"M8 21h8"}]]};
 ...
 * 
 */
const MonitorUp = createLucideIcon(iconData) as AstroComponent;
