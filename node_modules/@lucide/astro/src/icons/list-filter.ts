...
const iconData: LucideIconData = {"name":"list-filter","size":24,"node":[["path",{"d":"M2 5h20"}],["path",{"d":"M6 12h12"}],["path",{"d":"M9 19h6"}]]};
 ...
 * 
 */
const ListFilter = createLucideIcon(iconData) as AstroComponent;
