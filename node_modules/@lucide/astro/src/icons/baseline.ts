...
const iconData: LucideIconData = {"name":"baseline","size":24,"node":[["path",{"d":"M4 20h16"}],["path",{"d":"m6 16 6-12 6 12"}],["path",{"d":"M8 12h8"}]]};
 ...
 * 
 */
const Baseline = createLucideIcon(iconData) as AstroComponent;
