...
const iconData: LucideIconData = {"name":"align-horizontal-justify-start","size":24,"node":[["rect",{"width":"6","height":"14","x":"6","y":"5","rx":"2"}],["rect",{"width":"6","height":"10","x":"16","y":"7","rx":"2"}],["path",{"d":"M2 2v20"}]]};
 ...
 * 
 */
const AlignHorizontalJustifyStart = createLucideIcon(iconData) as AstroComponent;
