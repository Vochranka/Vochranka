...
const iconData: LucideIconData = {"name":"list-chevrons-up-down","size":24,"node":[["path",{"d":"M3 5h8"}],["path",{"d":"M3 12h8"}],["path",{"d":"M3 19h8"}],["path",{"d":"m15 8 3-3 3 3"}],["path",{"d":"m15 16 3 3 3-3"}]]};
 ...
 * 
 */
const ListChevronsUpDown = createLucideIcon(iconData) as AstroComponent;
