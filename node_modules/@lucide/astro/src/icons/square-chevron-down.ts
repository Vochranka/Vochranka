...
const iconData: LucideIconData = {"name":"square-chevron-down","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["path",{"d":"m16 10-4 4-4-4"}]],"aliases":["chevron-down-square"]};
 ...
 * 
 */
const SquareChevronDown = createLucideIcon(iconData) as AstroComponent;
