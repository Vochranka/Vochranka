...
const iconData: LucideIconData = {"name":"corner-down-right","size":24,"node":[["path",{"d":"m15 10 5 5-5 5"}],["path",{"d":"M4 4v7a4 4 0 0 0 4 4h12"}]]};
 ...
 * 
 */
const CornerDownRight = createLucideIcon(iconData) as AstroComponent;
