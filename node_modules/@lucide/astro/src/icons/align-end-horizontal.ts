...
const iconData: LucideIconData = {"name":"align-end-horizontal","size":24,"node":[["rect",{"width":"6","height":"16","x":"4","y":"2","rx":"2"}],["rect",{"width":"6","height":"9","x":"14","y":"9","rx":"2"}],["path",{"d":"M22 22H2"}]]};
 ...
 * 
 */
const AlignEndHorizontal = createLucideIcon(iconData) as AstroComponent;
