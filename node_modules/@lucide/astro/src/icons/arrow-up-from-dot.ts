...
const iconData: LucideIconData = {"name":"arrow-up-from-dot","size":24,"node":[["path",{"d":"m5 9 7-7 7 7"}],["path",{"d":"M12 16V2"}],["circle",{"cx":"12","cy":"21","r":"1"}]]};
 ...
 * 
 */
const ArrowUpFromDot = createLucideIcon(iconData) as AstroComponent;
