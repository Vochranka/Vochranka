...
const iconData: LucideIconData = {"name":"bluetooth-searching","size":24,"node":[["path",{"d":"m7 7 10 10-5 5V2l5 5L7 17"}],["path",{"d":"M20.83 14.83a4 4 0 0 0 0-5.66"}],["path",{"d":"M18 12h.01"}]]};
 ...
 * 
 */
const BluetoothSearching = createLucideIcon(iconData) as AstroComponent;
