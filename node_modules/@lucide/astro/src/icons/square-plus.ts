...
const iconData: LucideIconData = {"name":"square-plus","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["path",{"d":"M8 12h8"}],["path",{"d":"M12 8v8"}]],"aliases":["plus-square"]};
 ...
 * 
 */
const SquarePlus = createLucideIcon(iconData) as AstroComponent;
