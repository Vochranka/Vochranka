...
const iconData: LucideIconData = {"name":"arrow-down-to-dot","size":24,"node":[["path",{"d":"M12 2v14"}],["path",{"d":"m19 9-7 7-7-7"}],["circle",{"cx":"12","cy":"21","r":"1"}]]};
 ...
 * 
 */
const ArrowDownToDot = createLucideIcon(iconData) as AstroComponent;
