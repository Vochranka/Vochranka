...
const iconData: LucideIconData = {"name":"square-arrow-left","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["path",{"d":"m12 8-4 4 4 4"}],["path",{"d":"M16 12H8"}]],"aliases":["arrow-left-square"]};
 ...
 * 
 */
const SquareArrowLeft = createLucideIcon(iconData) as AstroComponent;
