...
const iconData: LucideIconData = {"name":"square-arrow-down-right","size":24,"node":[["path",{"d":"M15 15 9 9"}],["path",{"d":"M9 15h6V9"}],["rect",{"x":"3","y":"3","width":"18","height":"18","rx":"2"}]],"aliases":["arrow-down-right-square"]};
 ...
 * 
 */
const SquareArrowDownRight = createLucideIcon(iconData) as AstroComponent;
