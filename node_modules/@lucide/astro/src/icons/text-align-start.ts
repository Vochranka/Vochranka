...
const iconData: LucideIconData = {"name":"text-align-start","size":24,"node":[["path",{"d":"M21 5H3"}],["path",{"d":"M15 12H3"}],["path",{"d":"M17 19H3"}]],"aliases":["text","align-left"]};
 ...
 * 
 */
const TextAlignStart = createLucideIcon(iconData) as AstroComponent;
