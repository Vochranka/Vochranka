...
const iconData: LucideIconData = {"name":"columns-4","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["path",{"d":"M7.5 3v18"}],["path",{"d":"M12 3v18"}],["path",{"d":"M16.5 3v18"}]]};
 ...
 * 
 */
const Columns4 = createLucideIcon(iconData) as AstroComponent;
