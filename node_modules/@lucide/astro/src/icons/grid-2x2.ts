...
const iconData: LucideIconData = {"name":"grid-2x2","size":24,"node":[["path",{"d":"M12 3v18"}],["path",{"d":"M3 12h18"}],["rect",{"x":"3","y":"3","width":"18","height":"18","rx":"2"}]],"aliases":["grid-2-x-2"]};
 ...
 * 
 */
const Grid2x2 = createLucideIcon(iconData) as AstroComponent;
