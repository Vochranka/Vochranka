...
const iconData: LucideIconData = {"name":"radio-receiver","size":24,"node":[["path",{"d":"M5 16v2"}],["path",{"d":"M19 16v2"}],["rect",{"width":"20","height":"8","x":"2","y":"8","rx":"2"}],["path",{"d":"M18 12h.01"}]]};
 ...
 * 
 */
const RadioReceiver = createLucideIcon(iconData) as AstroComponent;
