...
const iconData: LucideIconData = {"name":"equal","size":24,"node":[["line",{"x1":"5","x2":"19","y1":"9","y2":"9"}],["line",{"x1":"5","x2":"19","y1":"15","y2":"15"}]]};
 ...
 * 
 */
const Equal = createLucideIcon(iconData) as AstroComponent;
