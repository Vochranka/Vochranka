...
const iconData: LucideIconData = {"name":"square-minus","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["path",{"d":"M8 12h8"}]],"aliases":["minus-square"]};
 ...
 * 
 */
const SquareMinus = createLucideIcon(iconData) as AstroComponent;
