...
const iconData: LucideIconData = {"name":"move-diagonal-2","size":24,"node":[["path",{"d":"M19 13v6h-6"}],["path",{"d":"M5 11V5h6"}],["path",{"d":"m5 5 14 14"}]]};
 ...
 * 
 */
const MoveDiagonal2 = createLucideIcon(iconData) as AstroComponent;
