...
const iconData: LucideIconData = {"name":"panel-left-close","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["path",{"d":"M9 3v18"}],["path",{"d":"m16 15-3-3 3-3"}]],"aliases":["sidebar-close"]};
 ...
 * 
 */
const PanelLeftClose = createLucideIcon(iconData) as AstroComponent;
