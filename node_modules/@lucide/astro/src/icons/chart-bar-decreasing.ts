...
const iconData: LucideIconData = {"name":"chart-bar-decreasing","size":24,"node":[["path",{"d":"M3 3v16a2 2 0 0 0 2 2h16"}],["path",{"d":"M7 11h8"}],["path",{"d":"M7 16h3"}],["path",{"d":"M7 6h12"}]]};
 ...
 * 
 */
const ChartBarDecreasing = createLucideIcon(iconData) as AstroComponent;
