...
const iconData: LucideIconData = {"name":"chart-no-axes-column","size":24,"node":[["path",{"d":"M5 21v-6"}],["path",{"d":"M12 21V3"}],["path",{"d":"M19 21V9"}]],"aliases":["bar-chart-2"]};
 ...
 * 
 */
const ChartNoAxesColumn = createLucideIcon(iconData) as AstroComponent;
