...
const iconData: LucideIconData = {"name":"ellipsis-vertical","size":24,"node":[["circle",{"cx":"12","cy":"12","r":"1"}],["circle",{"cx":"12","cy":"5","r":"1"}],["circle",{"cx":"12","cy":"19","r":"1"}]],"aliases":["more-vertical"]};
 ...
 * 
 */
const EllipsisVertical = createLucideIcon(iconData) as AstroComponent;
