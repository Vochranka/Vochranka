...
const iconData: LucideIconData = {"name":"panel-bottom-close","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["path",{"d":"M3 15h18"}],["path",{"d":"m15 8-3 3-3-3"}]]};
 ...
 * 
 */
const PanelBottomClose = createLucideIcon(iconData) as AstroComponent;
