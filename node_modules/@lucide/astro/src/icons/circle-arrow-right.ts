...
const iconData: LucideIconData = {"name":"circle-arrow-right","size":24,"node":[["circle",{"cx":"12","cy":"12","r":"10"}],["path",{"d":"m12 16 4-4-4-4"}],["path",{"d":"M8 12h8"}]],"aliases":["arrow-right-circle"]};
 ...
 * 
 */
const CircleArrowRight = createLucideIcon(iconData) as AstroComponent;
