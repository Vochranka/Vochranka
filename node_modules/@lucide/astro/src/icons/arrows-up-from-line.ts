...
const iconData: LucideIconData = {"name":"arrows-up-from-line","size":24,"node":[["path",{"d":"m4 6 3-3 3 3"}],["path",{"d":"M7 17V3"}],["path",{"d":"m14 6 3-3 3 3"}],["path",{"d":"M17 17V3"}],["path",{"d":"M4 21h16"}]]};
 ...
 * 
 */
const ArrowsUpFromLine = createLucideIcon(iconData) as AstroComponent;
