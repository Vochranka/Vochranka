...
const iconData: LucideIconData = {"name":"list-indent-increase","size":24,"node":[["path",{"d":"M21 5H11"}],["path",{"d":"M21 12H11"}],["path",{"d":"M21 19H11"}],["path",{"d":"m3 8 4 4-4 4"}]],"aliases":["indent","indent-increase"]};
 ...
 * 
 */
const ListIndentIncrease = createLucideIcon(iconData) as AstroComponent;
