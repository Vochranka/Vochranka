...
const iconData: LucideIconData = {"name":"move-horizontal","size":24,"node":[["path",{"d":"m18 8 4 4-4 4"}],["path",{"d":"M2 12h20"}],["path",{"d":"m6 8-4 4 4 4"}]]};
 ...
 * 
 */
const MoveHorizontal = createLucideIcon(iconData) as AstroComponent;
