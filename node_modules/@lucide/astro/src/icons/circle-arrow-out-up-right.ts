...
const iconData: LucideIconData = {"name":"circle-arrow-out-up-right","size":24,"node":[["path",{"d":"M22 12A10 10 0 1 1 12 2"}],["path",{"d":"M22 2 12 12"}],["path",{"d":"M16 2h6v6"}]],"aliases":["arrow-up-right-from-circle"]};
 ...
 * 
 */
const CircleArrowOutUpRight = createLucideIcon(iconData) as AstroComponent;
