...
const iconData: LucideIconData = {"name":"clock-5","size":24,"node":[["circle",{"cx":"12","cy":"12","r":"10"}],["path",{"d":"M12 6v6l2 4"}]]};
 ...
 * 
 */
const Clock5 = createLucideIcon(iconData) as AstroComponent;
