...
const iconData: LucideIconData = {"name":"pound-sterling","size":24,"node":[["path",{"d":"M18 7c0-5.333-8-5.333-8 0"}],["path",{"d":"M10 7v14"}],["path",{"d":"M6 21h12"}],["path",{"d":"M6 13h10"}]]};
 ...
 * 
 */
const PoundSterling = createLucideIcon(iconData) as AstroComponent;
