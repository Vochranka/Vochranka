...
const iconData: LucideIconData = {"name":"user-round-check","size":24,"node":[["path",{"d":"M2 21a8 8 0 0 1 13.292-6"}],["circle",{"cx":"10","cy":"8","r":"5"}],["path",{"d":"m16 19 2 2 4-4"}]],"aliases":["user-check-2"]};
 ...
 * 
 */
const UserRoundCheck = createLucideIcon(iconData) as AstroComponent;
