...
const iconData: LucideIconData = {"name":"battery-full","size":24,"node":[["path",{"d":"M10 10v4"}],["path",{"d":"M14 10v4"}],["path",{"d":"M22 14v-4"}],["path",{"d":"M6 10v4"}],["rect",{"x":"2","y":"6","width":"16","height":"12","rx":"2"}]]};
 ...
 * 
 */
const BatteryFull = createLucideIcon(iconData) as AstroComponent;
