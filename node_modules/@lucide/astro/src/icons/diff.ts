...
const iconData: LucideIconData = {"name":"diff","size":24,"node":[["path",{"d":"M12 3v14"}],["path",{"d":"M5 10h14"}],["path",{"d":"M5 21h14"}]]};
 ...
 * 
 */
const Diff = createLucideIcon(iconData) as AstroComponent;
