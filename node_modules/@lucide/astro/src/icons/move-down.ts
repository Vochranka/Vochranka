...
const iconData: LucideIconData = {"name":"move-down","size":24,"node":[["path",{"d":"M8 18L12 22L16 18"}],["path",{"d":"M12 2V22"}]]};
 ...
 * 
 */
const MoveDown = createLucideIcon(iconData) as AstroComponent;
