...
const iconData: LucideIconData = {"name":"arrow-up-narrow-wide","size":24,"node":[["path",{"d":"m3 8 4-4 4 4"}],["path",{"d":"M7 4v16"}],["path",{"d":"M11 12h4"}],["path",{"d":"M11 16h7"}],["path",{"d":"M11 20h10"}]],"aliases":["sort-asc"]};
 ...
 * 
 */
const ArrowUpNarrowWide = createLucideIcon(iconData) as AstroComponent;
