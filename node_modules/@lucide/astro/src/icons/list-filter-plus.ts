...
const iconData: LucideIconData = {"name":"list-filter-plus","size":24,"node":[["path",{"d":"M12 5H2"}],["path",{"d":"M6 12h12"}],["path",{"d":"M9 19h6"}],["path",{"d":"M16 5h6"}],["path",{"d":"M19 8V2"}]]};
 ...
 * 
 */
const ListFilterPlus = createLucideIcon(iconData) as AstroComponent;
