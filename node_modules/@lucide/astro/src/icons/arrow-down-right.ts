...
const iconData: LucideIconData = {"name":"arrow-down-right","size":24,"node":[["path",{"d":"m7 7 10 10"}],["path",{"d":"M17 7v10H7"}]]};
 ...
 * 
 */
const ArrowDownRight = createLucideIcon(iconData) as AstroComponent;
