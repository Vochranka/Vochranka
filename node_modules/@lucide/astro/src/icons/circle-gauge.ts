...
const iconData: LucideIconData = {"name":"circle-gauge","size":24,"node":[["path",{"d":"M15.6 2.7a10 10 0 1 0 5.7 5.7"}],["circle",{"cx":"12","cy":"12","r":"2"}],["path",{"d":"M13.4 10.6 19 5"}]],"aliases":["gauge-circle"]};
 ...
 * 
 */
const CircleGauge = createLucideIcon(iconData) as AstroComponent;
