...
const iconData: LucideIconData = {"name":"axis-3d","size":24,"node":[["path",{"d":"M13.5 10.5 15 9"}],["path",{"d":"M4 4v15a1 1 0 0 0 1 1h15"}],["path",{"d":"M4.293 19.707 6 18"}],["path",{"d":"m9 15 1.5-1.5"}]],"aliases":["axis-3-d"]};
 ...
 * 
 */
const Axis3d = createLucideIcon(iconData) as AstroComponent;
