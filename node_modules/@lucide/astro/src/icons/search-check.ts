...
const iconData: LucideIconData = {"name":"search-check","size":24,"node":[["path",{"d":"m8 11 2 2 4-4"}],["circle",{"cx":"11","cy":"11","r":"8"}],["path",{"d":"m21 21-4.3-4.3"}]]};
 ...
 * 
 */
const SearchCheck = createLucideIcon(iconData) as AstroComponent;
