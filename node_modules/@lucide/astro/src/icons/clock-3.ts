...
const iconData: LucideIconData = {"name":"clock-3","size":24,"node":[["circle",{"cx":"12","cy":"12","r":"10"}],["path",{"d":"M12 6v6h4"}]]};
 ...
 * 
 */
const Clock3 = createLucideIcon(iconData) as AstroComponent;
