...
const iconData: LucideIconData = {"name":"chart-column-increasing","size":24,"node":[["path",{"d":"M13 17V9"}],["path",{"d":"M18 17V5"}],["path",{"d":"M3 3v16a2 2 0 0 0 2 2h16"}],["path",{"d":"M8 17v-3"}]],"aliases":["bar-chart-4"]};
 ...
 * 
 */
const ChartColumnIncreasing = createLucideIcon(iconData) as AstroComponent;
