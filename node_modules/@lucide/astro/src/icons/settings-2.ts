...
const iconData: LucideIconData = {"name":"settings-2","size":24,"node":[["path",{"d":"M14 17H5"}],["path",{"d":"M19 7h-9"}],["circle",{"cx":"17","cy":"17","r":"3"}],["circle",{"cx":"7","cy":"7","r":"3"}]]};
 ...
 * 
 */
const Settings2 = createLucideIcon(iconData) as AstroComponent;
