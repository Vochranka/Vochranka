...
const iconData: LucideIconData = {"name":"toggle-right","size":24,"node":[["circle",{"cx":"15","cy":"12","r":"3"}],["rect",{"width":"20","height":"14","x":"2","y":"5","rx":"7"}]]};
 ...
 * 
 */
const ToggleRight = createLucideIcon(iconData) as AstroComponent;
