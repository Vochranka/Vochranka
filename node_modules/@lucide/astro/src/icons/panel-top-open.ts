...
const iconData: LucideIconData = {"name":"panel-top-open","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["path",{"d":"M3 9h18"}],["path",{"d":"m15 14-3 3-3-3"}]]};
 ...
 * 
 */
const PanelTopOpen = createLucideIcon(iconData) as AstroComponent;
