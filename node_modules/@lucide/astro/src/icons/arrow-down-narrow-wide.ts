...
const iconData: LucideIconData = {"name":"arrow-down-narrow-wide","size":24,"node":[["path",{"d":"m3 16 4 4 4-4"}],["path",{"d":"M7 20V4"}],["path",{"d":"M11 4h4"}],["path",{"d":"M11 8h7"}],["path",{"d":"M11 12h10"}]]};
 ...
 * 
 */
const ArrowDownNarrowWide = createLucideIcon(iconData) as AstroComponent;
