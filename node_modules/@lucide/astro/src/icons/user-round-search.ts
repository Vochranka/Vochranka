...
const iconData: LucideIconData = {"name":"user-round-search","size":24,"node":[["circle",{"cx":"10","cy":"8","r":"5"}],["path",{"d":"M2 21a8 8 0 0 1 10.434-7.62"}],["circle",{"cx":"18","cy":"18","r":"3"}],["path",{"d":"m22 22-1.9-1.9"}]]};
 ...
 * 
 */
const UserRoundSearch = createLucideIcon(iconData) as AstroComponent;
