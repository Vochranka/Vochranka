...
const iconData: LucideIconData = {"name":"circle-ellipsis","size":24,"node":[["circle",{"cx":"12","cy":"12","r":"10"}],["path",{"d":"M17 12h.01"}],["path",{"d":"M12 12h.01"}],["path",{"d":"M7 12h.01"}]]};
 ...
 * 
 */
const CircleEllipsis = createLucideIcon(iconData) as AstroComponent;
