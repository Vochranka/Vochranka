...
const iconData: LucideIconData = {"name":"square-chart-gantt","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["path",{"d":"M9 8h7"}],["path",{"d":"M8 12h6"}],["path",{"d":"M11 16h5"}]],"aliases":["gantt-chart-square","square-gantt-chart"]};
 ...
 * 
 */
const SquareChartGantt = createLucideIcon(iconData) as AstroComponent;
