...
const iconData: LucideIconData = {"name":"rows-3","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["path",{"d":"M21 9H3"}],["path",{"d":"M21 15H3"}]],"aliases":["panels-top-bottom"]};
 ...
 * 
 */
const Rows3 = createLucideIcon(iconData) as AstroComponent;
