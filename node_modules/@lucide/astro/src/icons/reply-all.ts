...
const iconData: LucideIconData = {"name":"reply-all","size":24,"node":[["path",{"d":"m12 17-5-5 5-5"}],["path",{"d":"M22 18v-2a4 4 0 0 0-4-4H7"}],["path",{"d":"m7 17-5-5 5-5"}]]};
 ...
 * 
 */
const ReplyAll = createLucideIcon(iconData) as AstroComponent;
