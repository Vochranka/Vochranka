...
const iconData: LucideIconData = {"name":"chevrons-up-down","size":24,"node":[["path",{"d":"m7 15 5 5 5-5"}],["path",{"d":"m7 9 5-5 5 5"}]]};
 ...
 * 
 */
const ChevronsUpDown = createLucideIcon(iconData) as AstroComponent;
