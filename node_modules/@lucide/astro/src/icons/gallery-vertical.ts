...
const iconData: LucideIconData = {"name":"gallery-vertical","size":24,"node":[["path",{"d":"M3 2h18"}],["rect",{"width":"18","height":"12","x":"3","y":"6","rx":"2"}],["path",{"d":"M3 22h18"}]]};
 ...
 * 
 */
const GalleryVertical = createLucideIcon(iconData) as AstroComponent;
