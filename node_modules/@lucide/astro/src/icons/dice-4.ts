...
const iconData: LucideIconData = {"name":"dice-4","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2","ry":"2"}],["path",{"d":"M16 8h.01"}],["path",{"d":"M8 8h.01"}],["path",{"d":"M8 16h.01"}],["path",{"d":"M16 16h.01"}]]};
 ...
 * 
 */
const Dice4 = createLucideIcon(iconData) as AstroComponent;
