...
const iconData: LucideIconData = {"name":"circle-arrow-down","size":24,"node":[["circle",{"cx":"12","cy":"12","r":"10"}],["path",{"d":"M12 8v8"}],["path",{"d":"m8 12 4 4 4-4"}]],"aliases":["arrow-down-circle"]};
 ...
 * 
 */
const CircleArrowDown = createLucideIcon(iconData) as AstroComponent;
