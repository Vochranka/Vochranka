...
const iconData: LucideIconData = {"name":"square-arrow-down","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["path",{"d":"M12 8v8"}],["path",{"d":"m8 12 4 4 4-4"}]],"aliases":["arrow-down-square"]};
 ...
 * 
 */
const SquareArrowDown = createLucideIcon(iconData) as AstroComponent;
