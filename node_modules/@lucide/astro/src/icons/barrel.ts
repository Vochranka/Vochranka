...
const iconData: LucideIconData = {"name":"barrel","size":24,"node":[["path",{"d":"M10 3a41 41 0 000 18"}],["path",{"d":"M14 3a41 41 0 010 18"}],["path",{"d":"M16.997 21a2 2 0 001.68-.92 15.25 15.25 0 000-16.16 2 2 0 00-1.68-.92h-10a2 2 0 00-1.681.92 15.25 15.25 0 000 16.16 2 2 0 001.681.92z"}],["path",{"d":"M3.54 16h16.914"}],["path",{"d":"M3.54 8h16.914"}]]};
 ...
 * 
 */
const Barrel = createLucideIcon(iconData) as AstroComponent;
