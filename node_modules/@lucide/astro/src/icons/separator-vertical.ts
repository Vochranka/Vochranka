...
const iconData: LucideIconData = {"name":"separator-vertical","size":24,"node":[["path",{"d":"M12 3v18"}],["path",{"d":"m16 16 4-4-4-4"}],["path",{"d":"m8 8-4 4 4 4"}]]};
 ...
 * 
 */
const SeparatorVertical = createLucideIcon(iconData) as AstroComponent;
