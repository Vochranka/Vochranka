...
const iconData: LucideIconData = {"name":"menu","size":24,"node":[["path",{"d":"M4 5h16"}],["path",{"d":"M4 12h16"}],["path",{"d":"M4 19h16"}]]};
 ...
 * 
 */
const Menu = createLucideIcon(iconData) as AstroComponent;
