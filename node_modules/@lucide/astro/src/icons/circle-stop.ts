...
const iconData: LucideIconData = {"name":"circle-stop","size":24,"node":[["circle",{"cx":"12","cy":"12","r":"10"}],["rect",{"x":"9","y":"9","width":"6","height":"6","rx":"1"}]],"aliases":["stop-circle"]};
 ...
 * 
 */
const CircleStop = createLucideIcon(iconData) as AstroComponent;
