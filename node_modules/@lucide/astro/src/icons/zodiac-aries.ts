...
const iconData: LucideIconData = {"name":"zodiac-aries","size":24,"node":[["path",{"d":"M12 7.5a4.5 4.5 0 1 1 5 4.5"}],["path",{"d":"M7 12a4.5 4.5 0 1 1 5-4.5V21"}]]};
 ...
 * 
 */
const ZodiacAries = createLucideIcon(iconData) as AstroComponent;
