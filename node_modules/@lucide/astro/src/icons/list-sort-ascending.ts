...
const iconData: LucideIconData = {"name":"list-sort-ascending","size":24,"node":[["path",{"d":"M3 19h18"}],["path",{"d":"M15 12H3"}],["path",{"d":"M9 5H3"}]]};
 ...
 * 
 */
const ListSortAscending = createLucideIcon(iconData) as AstroComponent;
