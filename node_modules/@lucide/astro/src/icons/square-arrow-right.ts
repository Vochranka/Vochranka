...
const iconData: LucideIconData = {"name":"square-arrow-right","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["path",{"d":"M8 12h8"}],["path",{"d":"m12 16 4-4-4-4"}]],"aliases":["arrow-right-square"]};
 ...
 * 
 */
const SquareArrowRight = createLucideIcon(iconData) as AstroComponent;
