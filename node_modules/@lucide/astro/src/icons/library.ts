...
const iconData: LucideIconData = {"name":"library","size":24,"node":[["path",{"d":"m16 6 4 14"}],["path",{"d":"M12 6v14"}],["path",{"d":"M8 8v12"}],["path",{"d":"M4 4v16"}]]};
 ...
 * 
 */
const Library = createLucideIcon(iconData) as AstroComponent;
