...
const iconData: LucideIconData = {"name":"undo-2","size":24,"node":[["path",{"d":"M9 14 4 9l5-5"}],["path",{"d":"M4 9h10.5a5.5 5.5 0 0 1 5.5 5.5a5.5 5.5 0 0 1-5.5 5.5H11"}]]};
 ...
 * 
 */
const Undo2 = createLucideIcon(iconData) as AstroComponent;
