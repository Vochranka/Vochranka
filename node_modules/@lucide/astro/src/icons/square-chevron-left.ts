...
const iconData: LucideIconData = {"name":"square-chevron-left","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["path",{"d":"m14 16-4-4 4-4"}]],"aliases":["chevron-left-square"]};
 ...
 * 
 */
const SquareChevronLeft = createLucideIcon(iconData) as AstroComponent;
