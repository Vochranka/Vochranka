...
const iconData: LucideIconData = {"name":"table-cells-split","size":24,"node":[["path",{"d":"M12 15V9"}],["path",{"d":"M3 15h18"}],["path",{"d":"M3 9h18"}],["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}]]};
 ...
 * 
 */
const TableCellsSplit = createLucideIcon(iconData) as AstroComponent;
