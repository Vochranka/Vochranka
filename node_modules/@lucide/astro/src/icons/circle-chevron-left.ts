...
const iconData: LucideIconData = {"name":"circle-chevron-left","size":24,"node":[["circle",{"cx":"12","cy":"12","r":"10"}],["path",{"d":"m14 16-4-4 4-4"}]],"aliases":["chevron-left-circle"]};
 ...
 * 
 */
const CircleChevronLeft = createLucideIcon(iconData) as AstroComponent;
