...
const iconData: LucideIconData = {"name":"case-lower","size":24,"node":[["path",{"d":"M10 9v7"}],["path",{"d":"M14 6v10"}],["circle",{"cx":"17.5","cy":"12.5","r":"3.5"}],["circle",{"cx":"6.5","cy":"12.5","r":"3.5"}]]};
 ...
 * 
 */
const CaseLower = createLucideIcon(iconData) as AstroComponent;
