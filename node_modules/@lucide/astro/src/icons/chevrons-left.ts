...
const iconData: LucideIconData = {"name":"chevrons-left","size":24,"node":[["path",{"d":"m11 17-5-5 5-5"}],["path",{"d":"m18 17-5-5 5-5"}]]};
 ...
 * 
 */
const ChevronsLeft = createLucideIcon(iconData) as AstroComponent;
