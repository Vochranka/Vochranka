...
const iconData: LucideIconData = {"name":"touchpad","size":24,"node":[["rect",{"width":"20","height":"16","x":"2","y":"4","rx":"2"}],["path",{"d":"M2 14h20"}],["path",{"d":"M12 20v-6"}]]};
 ...
 * 
 */
const Touchpad = createLucideIcon(iconData) as AstroComponent;
