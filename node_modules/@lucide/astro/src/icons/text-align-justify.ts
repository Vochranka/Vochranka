...
const iconData: LucideIconData = {"name":"text-align-justify","size":24,"node":[["path",{"d":"M3 5h18"}],["path",{"d":"M3 12h18"}],["path",{"d":"M3 19h18"}]],"aliases":["align-justify"]};
 ...
 * 
 */
const TextAlignJustify = createLucideIcon(iconData) as AstroComponent;
