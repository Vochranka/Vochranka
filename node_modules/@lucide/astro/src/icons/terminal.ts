...
const iconData: LucideIconData = {"name":"terminal","size":24,"node":[["path",{"d":"M12 19h8"}],["path",{"d":"m4 17 6-6-6-6"}]]};
 ...
 * 
 */
const Terminal = createLucideIcon(iconData) as AstroComponent;
