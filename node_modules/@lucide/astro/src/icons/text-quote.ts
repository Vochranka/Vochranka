...
const iconData: LucideIconData = {"name":"text-quote","size":24,"node":[["path",{"d":"M17 5H3"}],["path",{"d":"M21 12H8"}],["path",{"d":"M21 19H8"}],["path",{"d":"M3 12v7"}]]};
 ...
 * 
 */
const TextQuote = createLucideIcon(iconData) as AstroComponent;
