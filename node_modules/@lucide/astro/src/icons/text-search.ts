...
const iconData: LucideIconData = {"name":"text-search","size":24,"node":[["path",{"d":"M21 5H3"}],["path",{"d":"M10 12H3"}],["path",{"d":"M10 19H3"}],["circle",{"cx":"17","cy":"15","r":"3"}],["path",{"d":"m21 19-1.9-1.9"}]]};
 ...
 * 
 */
const TextSearch = createLucideIcon(iconData) as AstroComponent;
