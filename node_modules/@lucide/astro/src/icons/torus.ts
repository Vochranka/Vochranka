...
const iconData: LucideIconData = {"name":"torus","size":24,"node":[["ellipse",{"cx":"12","cy":"11","rx":"3","ry":"2"}],["ellipse",{"cx":"12","cy":"12.5","rx":"10","ry":"8.5"}]]};
 ...
 * 
 */
const Torus = createLucideIcon(iconData) as AstroComponent;
