...
const iconData: LucideIconData = {"name":"square-chevron-right","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["path",{"d":"m10 8 4 4-4 4"}]],"aliases":["chevron-right-square"]};
 ...
 * 
 */
const SquareChevronRight = createLucideIcon(iconData) as AstroComponent;
