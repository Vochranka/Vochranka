...
const iconData: LucideIconData = {"name":"circle-arrow-up","size":24,"node":[["circle",{"cx":"12","cy":"12","r":"10"}],["path",{"d":"m16 12-4-4-4 4"}],["path",{"d":"M12 16V8"}]],"aliases":["arrow-up-circle"]};
 ...
 * 
 */
const CircleArrowUp = createLucideIcon(iconData) as AstroComponent;
