...
const iconData: LucideIconData = {"name":"signal-low","size":24,"node":[["path",{"d":"M2 20h.01"}],["path",{"d":"M7 20v-4"}]]};
 ...
 * 
 */
const SignalLow = createLucideIcon(iconData) as AstroComponent;
