...
const iconData: LucideIconData = {"name":"circle-play","size":24,"node":[["path",{"d":"M9 9.003a1 1 0 0 1 1.517-.859l4.997 2.997a1 1 0 0 1 0 1.718l-4.997 2.997A1 1 0 0 1 9 14.996z"}],["circle",{"cx":"12","cy":"12","r":"10"}]],"aliases":["play-circle"]};
 ...
 * 
 */
const CirclePlay = createLucideIcon(iconData) as AstroComponent;
