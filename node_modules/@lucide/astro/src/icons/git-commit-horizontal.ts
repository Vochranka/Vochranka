...
const iconData: LucideIconData = {"name":"git-commit-horizontal","size":24,"node":[["circle",{"cx":"12","cy":"12","r":"3"}],["line",{"x1":"3","x2":"9","y1":"12","y2":"12"}],["line",{"x1":"15","x2":"21","y1":"12","y2":"12"}]],"aliases":["git-commit"]};
 ...
 * 
 */
const GitCommitHorizontal = createLucideIcon(iconData) as AstroComponent;
