...
const iconData: LucideIconData = {"name":"rectangle-ellipsis","size":24,"node":[["rect",{"width":"20","height":"12","x":"2","y":"6","rx":"2"}],["path",{"d":"M12 12h.01"}],["path",{"d":"M17 12h.01"}],["path",{"d":"M7 12h.01"}]],"aliases":["form-input"]};
 ...
 * 
 */
const RectangleEllipsis = createLucideIcon(iconData) as AstroComponent;
