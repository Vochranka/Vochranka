...
const iconData: LucideIconData = {"name":"arrow-up-right","size":24,"node":[["path",{"d":"M7 7h10v10"}],["path",{"d":"M7 17 17 7"}]]};
 ...
 * 
 */
const ArrowUpRight = createLucideIcon(iconData) as AstroComponent;
