...
const iconData: LucideIconData = {"name":"tornado","size":24,"node":[["path",{"d":"M21 4H3"}],["path",{"d":"M18 8H6"}],["path",{"d":"M19 12H9"}],["path",{"d":"M16 16h-6"}],["path",{"d":"M11 20H9"}]]};
 ...
 * 
 */
const Tornado = createLucideIcon(iconData) as AstroComponent;
