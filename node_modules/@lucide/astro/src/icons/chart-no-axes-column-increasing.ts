...
const iconData: LucideIconData = {"name":"chart-no-axes-column-increasing","size":24,"node":[["path",{"d":"M5 21v-6"}],["path",{"d":"M12 21V9"}],["path",{"d":"M19 21V3"}]],"aliases":["bar-chart"]};
 ...
 * 
 */
const ChartNoAxesColumnIncreasing = createLucideIcon(iconData) as AstroComponent;
