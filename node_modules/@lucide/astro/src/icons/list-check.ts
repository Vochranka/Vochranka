...
const iconData: LucideIconData = {"name":"list-check","size":24,"node":[["path",{"d":"M16 5H3"}],["path",{"d":"M16 12H3"}],["path",{"d":"M11 19H3"}],["path",{"d":"m15 18 2 2 4-4"}]]};
 ...
 * 
 */
const ListCheck = createLucideIcon(iconData) as AstroComponent;
