...
const iconData: LucideIconData = {"name":"user-round-plus","size":24,"node":[["path",{"d":"M2 21a8 8 0 0 1 13.292-6"}],["circle",{"cx":"10","cy":"8","r":"5"}],["path",{"d":"M19 16v6"}],["path",{"d":"M22 19h-6"}]],"aliases":["user-plus-2"]};
 ...
 * 
 */
const UserRoundPlus = createLucideIcon(iconData) as AstroComponent;
