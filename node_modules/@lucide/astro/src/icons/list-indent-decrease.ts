...
const iconData: LucideIconData = {"name":"list-indent-decrease","size":24,"node":[["path",{"d":"M21 5H11"}],["path",{"d":"M21 12H11"}],["path",{"d":"M21 19H11"}],["path",{"d":"m7 8-4 4 4 4"}]],"aliases":["outdent","indent-decrease"]};
 ...
 * 
 */
const ListIndentDecrease = createLucideIcon(iconData) as AstroComponent;
