...
const iconData: LucideIconData = {"name":"circle-arrow-out-down-left","size":24,"node":[["path",{"d":"M2 12a10 10 0 1 1 10 10"}],["path",{"d":"m2 22 10-10"}],["path",{"d":"M8 22H2v-6"}]],"aliases":["arrow-down-left-from-circle"]};
 ...
 * 
 */
const CircleArrowOutDownLeft = createLucideIcon(iconData) as AstroComponent;
