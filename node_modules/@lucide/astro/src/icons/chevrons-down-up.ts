...
const iconData: LucideIconData = {"name":"chevrons-down-up","size":24,"node":[["path",{"d":"m7 20 5-5 5 5"}],["path",{"d":"m7 4 5 5 5-5"}]]};
 ...
 * 
 */
const ChevronsDownUp = createLucideIcon(iconData) as AstroComponent;
