...
const iconData: LucideIconData = {"name":"check-line","size":24,"node":[["path",{"d":"M20 4L9 15"}],["path",{"d":"M21 19L3 19"}],["path",{"d":"M9 15L4 10"}]]};
 ...
 * 
 */
const CheckLine = createLucideIcon(iconData) as AstroComponent;
