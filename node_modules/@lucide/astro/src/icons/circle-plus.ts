...
const iconData: LucideIconData = {"name":"circle-plus","size":24,"node":[["circle",{"cx":"12","cy":"12","r":"10"}],["path",{"d":"M8 12h8"}],["path",{"d":"M12 8v8"}]],"aliases":["plus-circle"]};
 ...
 * 
 */
const CirclePlus = createLucideIcon(iconData) as AstroComponent;
