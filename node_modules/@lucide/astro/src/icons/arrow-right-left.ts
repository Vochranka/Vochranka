...
const iconData: LucideIconData = {"name":"arrow-right-left","size":24,"node":[["path",{"d":"m16 3 4 4-4 4"}],["path",{"d":"M20 7H4"}],["path",{"d":"m8 21-4-4 4-4"}],["path",{"d":"M4 17h16"}]]};
 ...
 * 
 */
const ArrowRightLeft = createLucideIcon(iconData) as AstroComponent;
