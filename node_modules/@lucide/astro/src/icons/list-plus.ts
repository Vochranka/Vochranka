...
const iconData: LucideIconData = {"name":"list-plus","size":24,"node":[["path",{"d":"M16 5H3"}],["path",{"d":"M11 12H3"}],["path",{"d":"M16 19H3"}],["path",{"d":"M18 9v6"}],["path",{"d":"M21 12h-6"}]]};
 ...
 * 
 */
const ListPlus = createLucideIcon(iconData) as AstroComponent;
