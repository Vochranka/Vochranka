...
const iconData: LucideIconData = {"name":"table-of-contents","size":24,"node":[["path",{"d":"M16 5H3"}],["path",{"d":"M16 12H3"}],["path",{"d":"M16 19H3"}],["path",{"d":"M21 5h.01"}],["path",{"d":"M21 12h.01"}],["path",{"d":"M21 19h.01"}]]};
 ...
 * 
 */
const TableOfContents = createLucideIcon(iconData) as AstroComponent;
