...
const iconData: LucideIconData = {"name":"arrow-up-down","size":24,"node":[["path",{"d":"m21 16-4 4-4-4"}],["path",{"d":"M17 20V4"}],["path",{"d":"m3 8 4-4 4 4"}],["path",{"d":"M7 4v16"}]]};
 ...
 * 
 */
const ArrowUpDown = createLucideIcon(iconData) as AstroComponent;
