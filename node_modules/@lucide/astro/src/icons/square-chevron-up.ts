...
const iconData: LucideIconData = {"name":"square-chevron-up","size":24,"node":[["rect",{"width":"18","height":"18","x":"3","y":"3","rx":"2"}],["path",{"d":"m8 14 4-4 4 4"}]],"aliases":["chevron-up-square"]};
 ...
 * 
 */
const SquareChevronUp = createLucideIcon(iconData) as AstroComponent;
